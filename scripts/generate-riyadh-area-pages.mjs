...
const sectors = [
  {
    ...
    intro: "صفحة قطاعية لتنظيم طلبات الخدمات القانونية من أحياء شمال الرياض. اختر الحي ثم حدّد هل احتياجك استشارة أو عقدًا أو قضية أسرية أو تجارية أو عقارية أو تنفيذًا، بدل إنشاء صفحة متشابهة لكل حي.",
    ...
    faqs: [
      ...
      ["هل توجد صفحة مستقلة لكل حي؟", "جُمعت الأحياء في صفحة قطاعية مفيدة لتجنب تكرار المحتوى. إذا ظهر لاحقًا احتياج بحث واضح لحي بعينه، يمكن إنشاء دليل مستقل بمعلومات وخدمة مختلفة فعليًا."],
  ...
  },
  {
    ...
    intro: "دليل خدمات قانونية لأحياء شرق الرياض يربط الموقع بالمسار التخصصي الصحيح. اذكر الحي ونوع الموضوع ومرحلته، ثم انتقل إلى دليل القضية أو العقد أو العمل أو التنفيذ بدل البحث بين صفحات مكررة.",
...
function renderSector(sector) {
  ...
  const schema = {"@context":"https://schema.org","@graph":[
    ...
    {"@type":"ItemList","@id":`${url}#neighborhoods`,name:`أحياء ${sector.name}`,numberOfItems:sector.neighborhoods.length,itemListElement:sector.neighborhoods.map((name,index)=>({"@type":"ListItem",position:index+1,name:`حي ${name}`}))},
  ...
  <section class="section" id="coverage"><div class="container"><div class="section-head"><span class="eyebrow">تغطية محلية مجمعة</span><h2>أحياء ${sector.name} المشمولة</h2><p>يستقبل الموقع الطلبات الأولية من الأحياء التالية ومن أي شارع أو مخطط داخلها، دون إنشاء صفحة مكررة لكل حي.</p></div><div class="locality-panel"><ul class="location-list">${sector.neighborhoods.map(name=>`<li>حي ${name}</li>`).join("")}</ul><p class="coverage-disclaimer">التغطية تعني استقبال الطلب إلكترونيًا من هذه المواقع، ولا تعني وجود فرع فعلي في كل حي.</p></div></div></section>
  <section class="section alt" id="services"><div class="container"><div class="section-head"><span class="eyebrow">مسارات قانونية</span><h2>اختر الخدمة بحسب جوهر الطلب</h2><p>تختلف متطلبات العقد عن القضية، وتختلف الدعوى عن التنفيذ؛ اختر المسار الأقرب للنتيجة التي تريدها.</p></div><div class="specialty-grid">${sector.routes.map(([title,text],index)=>`<article class="specialty-card" data-number="0${index+1}"><h3>${title}</h3><p>${text}</p></article>`).join("")}</div></div></section>
...
function renderHub() {
  ...
  const faqs = [
    ...
    ["لماذا لا توجد أربعون صفحة منفصلة للأحياء؟", "جُمعت الأحياء المتقاربة في صفحات قطاعية ذات محتوى مفيد حتى لا تصبح صفحات متشابهة هدفها تبديل اسم الحي فقط. يمكن ترقية حي إلى صفحة مستقلة لاحقًا إذا استحق محتوى وخدمة مختلفين."],
  ...
  return `<!DOCTYPE html><html lang="ar" dir="rtl"><head>${analytics}<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1"><title>خدمات قانونية في الرياض | دليل 40 حيًا</title><meta name="description" content="دليل خدمات قانونية في الرياض يغطي 40 حيًا عبر شمال وشرق ووسط وغرب وجنوب المدينة، مع مسارات للعقود والقضايا والأسرة والعمل والتجارة والعقار والتنفيذ."><link rel="canonical" href="${url}"><link rel="alternate" hreflang="ar" href="${url}"><link rel="alternate" hreflang="x-default" href="${url}"><meta property="og:type" content="website"><meta property="og:locale" content="ar_SA"><meta property="og:site_name" content="رُكن الأنظمة القانونية"><meta property="og:title" content="خدمات قانونية في الرياض | دليل الأحياء والقطاعات"><meta property="og:description" content="اختر قطاع الرياض وحيك ثم انتقل إلى المسار القانوني المناسب دون صفحات أحياء مكررة."><meta property="og:url" content="${url}"><script type="application/ld+json">${JSON.stringify(schema)}</script><link rel="stylesheet" href="styles.css"></head><body>
  ...
  <section class="hero service-detail-hero"><div class="container hero-grid"><div class="hero-copy"><span class="eyebrow">5 قطاعات • 40 حيًا</span><h1>خدمات قانونية في الرياض<br><span>دليل الأحياء والقطاعات</span></h1><p>ابدأ من موقعك داخل الرياض، ثم اختر التخصص القانوني بحسب نوع الطلب ومرحلته. يجمع الدليل الأحياء الأربعين في خمس صفحات قطاعية قوية بدل إنشاء صفحات متشابهة لا تضيف قيمة للزائر.</p><div class="hero-actions"><a class="btn primary" href="#sectors">اختر قطاعك</a><a class="btn secondary" href="#services">اختر الخدمة</a></div><div class="trust-row"><div><b>40 حيًا</b><span>تغطية واضحة</span></div><div><b>5 قطاعات</b><span>هيكل قابل للتصفح</span></div><div><b>لا فروع وهمية</b><span>استقبال إلكتروني</span></div></div></div><aside class="service-hero-aside" aria-label="دليل أحياء الرياض"><span class="service-badge">مدينة الرياض</span><div class="service-symbol" aria-hidden="true">40</div><h2>من الحي إلى التخصص</h2><p>اختر القطاع والحي، ثم حدد موضوع القضية ومرحلتها.</p><ul class="service-hero-points"><li>شمال وشرق الرياض</li><li>وسط وغرب الرياض</li><li>جنوب الرياض</li></ul></aside></div></section>
  ...
  <section class="section alt" id="all-neighborhoods"><div class="container"><div class="section-head"><span class="eyebrow">قائمة كاملة</span><h2>الأحياء الأربعون داخل دليل الرياض</h2><p>الأسماء التالية ظاهرة وموزعة على صفحات القطاعات، ويشمل النطاق أي شارع أو مخطط داخل كل حي.</p></div><div class="locality-panels"><article class="locality-panel"><h3>شمال ووسط الرياض</h3><ul class="location-list">${[...sectors[0].neighborhoods,...sectors[2].neighborhoods].map(name=>`<li>حي ${name}</li>`).join("")}</ul></article><article class="locality-panel"><h3>شرق وغرب وجنوب الرياض</h3><ul class="location-list">${[...sectors[1].neighborhoods,...sectors[3].neighborhoods,...sectors[4].neighborhoods].map(name=>`<li>حي ${name}</li>`).join("")}</ul></article></div><p class="coverage-disclaimer">التغطية تعني استقبال الطلبات إلكترونيًا من هذه الأحياء، ولا تعني وجود فرع أو مكتب فعلي في كل حي.</p></div></section>
  <section class="section" id="services"><div class="container"><div class="section-head"><span class="eyebrow">بعد اختيار الحي</span><h2>اختر التخصص القانوني المناسب</h2><p>الموقع يحدد النطاق الجغرافي، بينما يحدد موضوع الطلب الخدمة والمستندات المطلوبة.</p></div><div class="specialty-grid"><article class="specialty-card" data-number="01"><h3>استشارات وقضايا</h3><p>لفهم الموقف والخيارات أو ترتيب ملف قضية قائمة ومواعيدها ومتطلباتها.</p></article><article class="specialty-card" data-number="02"><h3>الأسرة والعمل</h3><p>لمسائل الأحوال الشخصية والتركات وعلاقات العمل والأجور والمستحقات.</p></article><article class="specialty-card" data-number="03"><h3>التجارة والعقود</h3><p>للشركات والشركاء والمطالبات وصياغة الاتفاقيات ومراجعة الالتزامات.</p></article><article class="specialty-card" data-number="04"><h3>العقار والتنفيذ</h3><p>للعقار والإيجار والمقاولات والأحكام والسندات والمطالبات التنفيذية.</p></article></div></div></section>
  <section class="section alt" id="method"><div class="container prep-layout"><div class="prep-intro"><span class="eyebrow">هيكل مفيد للزائر</span><h2>لماذا خمس صفحات بدل أربعين نسخة؟</h2><p>القطاع يمنح الزائر قائمة واضحة من الأحياء ومسارات عملية، ويمنح محركات البحث هرمًا قابلًا للتصفح من مدينة الرياض إلى القطاع ثم إلى التخصص. وإذا أثبت حي معين طلبًا واضحًا، يمكن إنشاء دليل مستقل له بمحتوى وخدمة مختلفين فعليًا.</p></div><ol class="document-list"><li>اختر قطاع الرياض الذي يقع فيه الحي</li><li>افتح صفحة القطاع واقرأ نطاق الأحياء</li><li>حدّد نوع القضية أو الخدمة المطلوبة</li><li>اذكر المرحلة والجهة وأقرب موعد</li><li>ابدأ بملخص دون بيانات شديدة الحساسية</li></ol></div></section>
