...
- Batches four through seven are generated from `scripts/generate-national-waves4-7.mjs` with source data in `scripts/national-waves4-7-data.mjs`. Batch eight is generated from `scripts/generate-national-wave8.mjs` with source data in `scripts/national-wave8-data.mjs`. Batch nine is generated from `scripts/generate-national-wave9.mjs` with source data in `scripts/national-wave9-data.mjs`; never hand-edit generated `saudi-guide-w1-*.html` through `saudi-guide-w9-*.html` files.
...
- For batch nine, run `npm run generate:national-wave9`, then `npm run check:national-wave9`, `npm run audit:seo`, `npm run audit:keywords`, and `npm run check:server` before committing.
