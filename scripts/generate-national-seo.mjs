...
function nationalGuide() {
  ...
  const waveGuides = readdirSync(root)
    .filter((name) => /^saudi-guide-w1-.+\.html$/i.test(name))
    .sort()
  ...
  <div class="service-jump-wrap"><nav class="container service-jump" aria-label="روابط داخل الصفحة"><a href="#regions">المناطق</a><a href="#services">الخدمات</a>${waveGuides.length ? '<a href="#wave1-guides">أدلة اليوم</a>' : ""}<a href="#prepare">تجهيز الطلب</a><a href="#faq">الأسئلة</a></nav></div>
